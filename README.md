...
3. กรอก otp แล้วกดส่ง
4. จะได้รับ deviceid มา ให้นำไปเก็บหรือใช้ได้ตามสะดวก
5. วิธีเช็คว่า deviceid เรามันพังหรือใช้ได้มั้ย ใช้วิธีนี้ /api/v1/scb/check_device ส่งข้อมูลไปที่นี่
